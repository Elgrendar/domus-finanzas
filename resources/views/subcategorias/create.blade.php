...
@section('contenido')
    <div class="container-fluid py-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="mb-0">Crear nueva subcategoría</h4>
                ...
                <form action="{{ route('subcategorias.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="tipo_subcategoria" id="tipo_subcategoria" class="form-select" required>
                            ...
                            <option value="ingreso" {{ old('tipo_subcategoria') == 'ingreso' ? 'selected' : '' }}>Ingreso
                            </option>
                            <option value="gasto" {{ old('tipo_subcategoria') == 'gasto' ? 'selected' : '' }}>Gasto
                            </option>
                        </select>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="color" name="color" id="color" class="form-control"
                            value="{{ old('color') }}" placeholder="Ejemplo: #ff0000">
                    </div>
                    <div class="mb-3">
