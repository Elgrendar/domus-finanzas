...
<body>
    @auth
        ...
        <nav class="navbar fixed-top navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ route('inicio.index') }}">Domus Finanzas</a>
        ...
        <div class="sidebar" id="sidebarMenu">
            <nav class="nav flex-column pt-3">
                ...
                <a href="{{ route('formasdepago.index') }}"
                    class="nav-link {{ request()->routeIs('formasdepago.index') ? 'active' : '' }}"
                    data-bs-toggle="tooltip" title="Formas de Pago">
    ...
    @guest
        <div class="container mt-5">
            <h1 class="text-center">Bienvenido a Domus Finanzas</h1>
